...
echo "from cobrancas.models import Cobranca; \
...
Cobranca.objects.create(nome='Cliente 2', documento='98765432109', email='cliente2@example.com', valor='200.00', data_vencimento='2024-09-15', uuid='uuid-2')" | python manage.py shell
