        ...
        <div className="dashboard-card--small">
            ...
            {loading ? (
                ...
                <ul className="recent-uploads-list">
                    {statements.map(s => (
                        <li key={s.id} className={`recent-uploads-row${s.status === 'failed' ? ' recent-uploads-row--failed' : ''}`}>
                            <div className="recent-uploads-row__tags">
                                <span
